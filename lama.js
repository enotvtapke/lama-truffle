...
wasmImports.jsbody = {
	...
	'_JSValue.stringValue___String' : (...args) => (function(){
		try{
			...
			conversion.handleJSError(e);}}).call(...args),
	'_LamaWasm.installRunLama___Function_V' : (...args) => (function(handler){
		try{
			globalThis.runLama = handler;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_LamaWasm.installSetInput___Function_V' : (...args) => (function(handler){
		try{
			globalThis.setLamaInput = handler;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
