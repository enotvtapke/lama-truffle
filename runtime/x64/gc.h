...
// Bumped from the upstream 32: Barray/Bsexp/Bclosure push one extra root per
// element, so constructing any array/sexp/closure with more than ~31 elements
// overflowed the pool (the self-hosted compiler's makeEnv builds a 71-element
// array). Large enough for the compiler's needs; cheap BSS-only cost.
